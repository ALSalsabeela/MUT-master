...
public class MapFragment extends Fragment {
	...
	{	
		...
		Fragment fragment = (getActivity().getSupportFragmentManager().findFragmentById(R.id.fragmentmap));  
		if(fragment!= null)
	...
	Marker marker =null;
		private void setUpMapIfNeeded() {
			...
			if (map == null) {
				map = ((SupportMapFragment)getActivity().getSupportFragmentManager().findFragmentById(R.id.fragmentmap))
                .getMap() ;
